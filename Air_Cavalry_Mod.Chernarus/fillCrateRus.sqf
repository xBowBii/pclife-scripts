...
switch (rusEra) do
{
        ...
        case 2:
        {
                ...
                ammoCrateRus addWeaponCargo ["ACE_AK74M_GL_Kobra",5];
                ammoCrateRus addWeaponCargo ["ACE_AK74M_PSO",5];
                ammoCrateRus addWeaponCargo ["ACE_AK74M_GL_PSO",2];
                ammoCrateRus addWeaponCargo ["ACE_AK74M_GL_1P78",5];
        ...
        case 3:
        {
                ...
                ammoCrateRus addWeaponCargo ["ACE_AK74M_TWS",5];
                ammoCrateRus addWeaponCargo ["ACE_AK74M_GL_TWS",5];
...
ammoCrateRus addMagazineCargo ["ACE_30Rnd_762x39_AP_AK47",60];
ammoCrateRus addMagazineCargo ["30Rnd_762x39_AK47",60];

ammoCrateRus addMagazineCargo ["ACE_40Rnd_762x39_B_AK47",60];
ammoCrateRus addMagazineCargo ["ACE_75Rnd_762x39_B_AK47",60];

ammoCrateRus addMagazineCargo ["ACE_30Rnd_545x39_T_AK",60];
ammoCrateRus addMagazineCargo ["ACE_30Rnd_545x39_AP_AK",60];
ammoCrateRus addMagazineCargo ["ACE_30Rnd_545x39_EP_AK",60];
ammoCrateRus addMagazineCargo ["30Rnd_545x39_AK",60];

ammoCrateRus addMagazineCargo ["ACE_75Rnd_545x39_T_RPK",60];
ammoCrateRus addMagazineCargo ["ACE_45Rnd_545x39_AP_AK",60];
ammoCrateRus addMagazineCargo ["ACE_45Rnd_545x39_EP_AK",60];
ammoCrateRus addMagazineCargo ["ACE_45Rnd_545x39_B_AK",60];
