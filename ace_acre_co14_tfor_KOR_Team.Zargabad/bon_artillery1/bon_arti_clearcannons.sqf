...
_cannons_cleared = [];
{
	...
	_requestor setVariable [format["Arti_%2_Cannon%1",_x+1,playerSide],nil,bon_arti_global];
} foreach lbSelection _listbox;
_requestor setVariable ["requesting_cannons",_cannons_to_clear,bon_arti_global];
