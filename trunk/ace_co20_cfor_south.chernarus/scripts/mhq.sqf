...
if(tfor_mhqrespawn == 0 && not alive tfor_mhq) exitWith{hint parseText "<t size='1.25' color='#ef2525'>Your team's MHQ has been destroyed.</t>"};
...
if(tfor_mhqrespawn == 0) then{
	tfor_mhq spawn {
		...
		hint parseText "<t size='1.0' color='#ef2525'>Your team's MHQ has been destroyed.</t>";
