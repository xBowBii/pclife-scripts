...
// tfor_deathcount > tfor_max_death_per_mission (set as mission parameter)
// to let the mission fail (or any other int value)
//
//
// Then add the filename of this mission into the tfor_missions array
// (scripts\missions\missionmanager.sqf, somewhere about line 10)
//
// and add a respective task to the switch-case-structure in
// scripts\missions\tasks.sqf <- should be self-explaining, just copy and paste
// an existing task and modify the text.
//
///////////////////////////////////////////////////////////////////////////////
//
// NOTES:
