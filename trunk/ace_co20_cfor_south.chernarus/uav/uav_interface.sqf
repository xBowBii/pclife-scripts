scriptName "uav\uav_interface.sqf";
/*
...
_linked = _logic getvariable "uavList";
_uav = objnull;
{
	if (vehicle _x iskindof "uav" && alive vehicle _x) then {_uav = vehicle _x};
} foreach _linked;
...
_terminalsAll = _logic getvariable 'terminals';
_terminal = objnull;
{
...
_action_leave = _uav addaction [
	...
	BON_UAV_PATH+"uav_actionCommit.sqf",
	[0],
	1,
	false,
	true,
