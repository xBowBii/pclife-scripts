...
_logic setvariable ["path_menu",(BON_HC_PATH+"HC_GUI_menu.sqf")];
_logic setvariable ["path_stat",compile preprocessfilelinenumbers (BON_HC_PATH+"HC_GUI_stat.sqf")];

BIS_HC_path_menu = compile preprocessfilelinenumbers (BON_HC_PATH+"HC_GUI_menu.sqf");
...
_GUI_WP_MOVE = {scriptname "HC: _GUI_WP_MOVE";
	...
	//[_sound] execVM (BON_HC_PATH+"HC_sound.sqf");
