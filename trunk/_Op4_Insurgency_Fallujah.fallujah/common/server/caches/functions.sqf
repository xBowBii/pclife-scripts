cacheKilled = { 	
	...
	curTime	= time; 
	_dur	= 5 + random 5; 
_boom1 = "ACE_PipebombExplosion" createVehicle _pos;
_boom2 = "ACE_PipebombExplosion" createVehicle [(_pos select 0) + 2.5, _pos select 1, _pos select 2];
_boom3 = "ACE_PipebombExplosion" createVehicle [(_pos select 0) - 2.5, _pos select 1, _pos select 2];
_boom4 = "ACE_PipebombExplosion" createVehicle [_pos select 0, (_pos select 1) + 2.5, _pos select 2];
_boom5 = "ACE_PipebombExplosion" createVehicle [_pos select 0, (_pos select 1) - 2.5, _pos select 2];
_he = "sh_125_he" createVehicle _pos;
_wp1 = "sh_105_wp" createVehicle _pos;
_wp2 = "ACE_M34" createVehicle _pos;
_sm = "ARTY_SmokeShellWhite" createVehicle _pos;
sleep 0.25;
_boom1 = "ACE_PipebombExplosion" createVehicle _pos;
_boom2 = "ACE_PipebombExplosion" createVehicle [(_pos select 0) + 2.5, _pos select 1, _pos select 2];
_boom3 = "ACE_PipebombExplosion" createVehicle [(_pos select 0) - 2.5, _pos select 1, _pos select 2];
