...
_trg = createTrigger ["EmptyDetector", position player]; 
_trg setTriggerText "View Distance - 250"; 
_trg setTriggerActivation ["DELTA", "PRESENT", true]; 
_trg setTriggerStatements ["this", 'if (viewDistance > 0) then { setViewDistance (viewDistance - 250); }; hintSilent format["View Distance: %1", viewDistance]', ""]; 

_trg = createTrigger ["EmptyDetector", position player]; 
_trg setTriggerText "View Distance + 250"; 
_trg setTriggerActivation ["ECHO", "PRESENT", true]; 
_trg setTriggerStatements ["this", 'if (viewDistance < 10000) then { setViewDistance (viewDistance + 250); }; hintSilent format["View Distance: %1", viewDistance]', ""]; 
