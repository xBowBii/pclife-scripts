...
player addEventHandler ["Killed",{
	...
	player spawn {
		...
		if(_livesleft <= 5 && _livesleft >= 0) then {
			hintSilent parseText format["<t size='1.25' font='Zeppelin33' color='#ff0000'>%1 жизней осталось.</t>",floor (tfor_max_death_per_mission - tfor_deathcount)];
		};
		...
		sniper setObjectTexture [0,"04.paa"];
