  ...
  // ==============================================================
    ...
    // True / False, default is True
      ...
      // 0 - 50000, default is [ ["Man", 3000], ["Car", 7000], ["Tank", 10000], ["Air", 30000], ["Ship", 30000] ]
         GL4_Global set [7, [ ["Man", 2000], ["Car", 3000], ["Tank", 10000], ["Air", 30000], ["Ship", 30000] ] ];
    ...
    // True / False, default is True
      ...
      // Choose the difficult "Skill Types" of specific enemy A.I. classes and ranks.
         GL4_Global set [49, call compile preprocessFile "\UserConfig\GL4\GL4_Skill_Types.sqf" ];
