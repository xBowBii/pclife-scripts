...
if(isNil "_req_cannons") then{_req_cannons = []};
{
	...
	_requestor setVariable ["requesting_cannons",_req_cannons,bon_arti_global];
	_requestor setVariable [format["Arti_%2_Cannon%1",_x+1,playerSide],[_splashpos,_firedelay,_artitype,_arty_nrshells,_artispread_value],bon_arti_global];
