...
player createDiaryRecord ["Diary",["Op4 Mission Information","<br/>Base assets are on very long respawn timers, MHQ assets are normal.  Abuse of base assets will be punished.<br/><br/>ACE wounding system is enabled.  All players can use bandages, morphine, and epinephrine, but only corpsmen can perform first aid.<br/><br/>Opfor slots are restricted to Op4 members of 13th TOC status.<br/><br/>Vehicle service can take a few minutes and varies by vehicle type.<br/><br/>Weapon selection is restricted based on your role.<br/><br/>IEDs are present.  See something suspicious?  Hit it with a 203, AT, or just stay the hell away.<br/><br/>Transport is available between the MHQ and FOB.  Check the M1025 near the FOB gate for transport."]];
player createDiaryRecord ["Diary",["Op4Gaming Information","<img image='op4\op4_small.paa' width='200' height='200'/><br/><br/>www.op4gaming.com recruiting open to North American players age 18 and up.<br/><br/>Teamspeak Address: 208.74.9.26:9987, ARMA 2 channel.<br/><br/>Teamspeak presence required for air and armor use.<br/><br/>Converted to ACE and heavily modified by Strikor<br/><img image='op4\strikor.paa' width='200' height='200'/>"]];