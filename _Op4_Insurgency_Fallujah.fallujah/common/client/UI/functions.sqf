fillOptionsDialog = {
	...
	} forEach ["Grass Enabled", "Grass Disabled"];
};
...
respawnTags = {
	...
	_ctrlText = (uiNamespace getVariable 'TAGS_HUD') displayCtrl 64434; 	
	_ctrlText ctrlSetStructuredText parseText format[
		"<t color='%2' shadow='1' shadowColor='#000000'>%1</t><br/><br/><t color='#808080' shadow='1' shadowColor='#000000'>Left Arrow: Previous unit<br/>Right Arrow: Next unit</t>"
	, _txt, _color];
}; 
