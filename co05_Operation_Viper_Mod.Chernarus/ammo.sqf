...
//AR
_this addWeaponCargo ["ACE_MG36A1_D",2];
_this addWeaponCargo ["ACE_RPK",2];
_this addWeaponCargo ["ACE_M249Para",2];
_this addWeaponCargo ["ACE_M249Para_M145",2];
_this addWeaponCargo ["ACE_RPK74M_1P29",2];

//MACHINEGUNZ
_this addWeaponCargo ["M249",2];
_this addWeaponCargo ["RPK_74",2];
_this addWeaponCargo ["M60A4_EP1",2];
_this addWeaponCargo ["Mk_48_DES_EP1",2];
_this addWeaponCargo ["Pecheneg",2];
_this addWeaponCargo ["ACE_M240G_M145",2];

//Pistols
_this addWeaponCargo ["ACE_Flaregun",2];
_this addWeaponCargo ["ACE_Glock17",2];
_this addWeaponCargo ["ACE_USPSD",2];

//Rifles
_this addWeaponCargo ["ACE_AK103_1P29",2];
_this addWeaponCargo ["ACE_AK103_GL_Kobra",2];
_this addWeaponCargo ["ACE_AK103_GL_PSO",2];
_this addWeaponCargo ["ACE_AK103_Kobra",2];
_this addWeaponCargo ["ACE_AK103",2];
_this addWeaponCargo ["ACE_AK104",2];
_this addWeaponCargo ["ACE_AK104_1P29",2];
_this addWeaponCargo ["ACE_AK104_Kobra",2];
...
_this addWeaponCargo ["ACE_AKM_GL",2];
_this addWeaponCargo ["ACE_AK74M_GL_PSO",2];
_this addWeaponCargo ["ACE_AKMS_SD",2];
_this addWeaponCargo ["AK_107_kobra",2];
_this addWeaponCargo ["AK_107_GL_kobra",2];
_this addWeaponCargo ["AK_107_GL_pso",2];
_this addWeaponCargo ["AKS_74_UN_kobra",2];
_this addWeaponCargo ["G36K",2];
_this addWeaponCargo ["ACE_G36A1",2];
_this addWeaponCargo ["ACE_G36A1_AG36A1_D_UP",2];
_this addWeaponCargo ["ACE_G36A2_Bipod_D",2];
_this addWeaponCargo ["ACE_gr1",2];
_this addWeaponCargo ["ACE_gr1sd",2];
_this addWeaponCargo ["ACE_gr1sp",2];
_this addWeaponCargo ["ACE_HK416_D10_COMPM3_SD",2];
_this addWeaponCargo ["ACE_HK416_D10_Holo",2];
_this addWeaponCargo ["ACE_HK416_D10_M320_UP",2];
_this addWeaponCargo ["ACE_HK416_D14_COMPM3",2];
_this addWeaponCargo ["ACE_HK416_D14_COMPM3_M320_UP",2];
_this addWeaponCargo ["ACE_M16A4_ACG_GL_UP",2];
_this addWeaponCargo ["M16A4_ACG",2];
_this addWeaponCargo ["ACE_M16A4_CCO_GL",2];
_this addWeaponCargo ["M4A1_HWS_GL",2];
_this addWeaponCargo ["M4A1_HWS_GL_SD_Camo",2];
_this addWeaponCargo ["M4A1_RCO_GL",2];
_this addWeaponCargo ["M4A1_Aim",2];
_this addWeaponCargo ["M4A3_CCO_EP1",2];
_this addWeaponCargo ["M4A1_AIM_SD_camo",2];
_this addWeaponCargo ["ACE_M4_AIM_GL_UP",2];
_this addWeaponCargo ["ACE_SOC_M4A1_Eotech",2];
_this addWeaponCargo ["ACE_SOC_M4A1_SHORTDOT",2];
_this addWeaponCargo ["ACE_M27_IAR_ACOG",2];
_this addWeaponCargo ["AKS_74_GOSHAWK",2];
_this addWeaponCargo ["FN_FAL_ANPVS4",2];
_this addWeaponCargo ["M14_EP1",2];

//Rucks
_this addWeaponCargo ["ACE_PRC119",2];
_this addWeaponCargo ["ACE_Rucksack_RD90",2];
_this addWeaponCargo ["ACE_VTAC_RUSH72",2];

//Sniper rifles
_this addWeaponCargo ["VSS_vintorez",2];
_this addWeaponCargo ["DMR",2];
_this addWeaponCargo ["KSVK",2];
_this addWeaponCargo ["M107",2];
_this addWeaponCargo ["SVD",2];
_this addWeaponCargo ["ACE_M4SPR_SD",2];
_this addWeaponCargo ["ACE_Mk12mod1",2];
_this addWeaponCargo ["ACE_M110_SD",2];
_this addWeaponCargo ["ACE_Val_PSO",2];
_this addWeaponCargo ["ACE_TAC50",2];
_this addWeaponCargo ["m107_TWS_EP1",2];

//SMG
_this addWeaponCargo ["ACE_UMP45",2];
_this addWeaponCargo ["ACE_UMP45_SD",2];
_this addWeaponCargo ["G36C_camo",2];
_this addWeaponCargo ["G36C",2];
_this addWeaponCargo ["G36_C_SD_eotech",2];
_this addWeaponCargo ["bizon",2];
_this addWeaponCargo ["bizon_silenced",2];
_this addWeaponCargo ["ACE_KAC_PDW",2];
_this addWeaponCargo ["MP5A5",2];
_this addWeaponCargo ["MP5SD",2];
...
_this addMagazineCargo ["TimeBomb",25];
_this addMagazineCargo ["PipeBomb",25];
_this addMagazineCargo ["Mine",5];
_this addMagazineCargo ["MineE",5];