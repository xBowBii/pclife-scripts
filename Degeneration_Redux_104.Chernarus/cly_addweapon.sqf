...
{if !(_x in ["FlareLauncher","SmokeLauncher","CMFlareLauncher"]) then {_unit removeWeapon _x}} forEach weapons _unit;
...
{_throwputmags set [_forEachIndex,toLower _x]} forEach _throwputmags;
